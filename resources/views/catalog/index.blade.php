				...
				<div class="sp-right">
					...
					@if(count($artists) != 0)
						@foreach($artists as $a)
							<div class="sp-spisok">
								<div class="sp-person">
								<a href="/artist/{{ $a->id ?? 1 }}">
									<div class="sp-all-about">
										<div class="sp-avatar"><img src='{{ asset($a->image ?? '/images/artist.png') }}' alt="">{{ $a->title ?? 'Artist name' }}</div>
										<div class="sp-naa">
											<div class="sp-name"><span></span>{{ $a->title ?? 'Artist name' }}</div>
											<div class="sp-other">
												<div class="sp-o-address">{{ $a->location ?? 'No location' }}</div>
												<div class="sp-o-view">{{ $a->views ?? 0 }}</div>
												<div class="sp-o-comment">{{ $a->likes ?? 0 }}</div>
												
											</div>
										</div>
										<div class="sp-par">
											<div class="sp-cost">@if($a->price) {{ $a->price . ' rub' }} @else договорной @endif</div>
					...
					@else
						<br><br><br>
						<h3>There is no artists in this group yet.</h3>
					@endif
					<div class="nb-navig">
						<ul>
